...
cp /app/launch_dir/launch_6.py /app/ros2_ws/src/game/launch/launch.py
echo "已复制 launch_6.py 到目标目录 /app/ros2_ws/src/game/launch/"

config_name="fixed_high_order"
draw_model="fixed_high_order"
# 定义配置索引列表
# config_indices=("3_1" "3_2" "3_3" "3_4" "3_5" "3_6")
# config_indices=("3_11" "3_12" "3_13")
config_indices=("r_0")
# config_indices=("r_1" "r_2" "r_3" "r_4" "r_5")
# config_indices=("5")
