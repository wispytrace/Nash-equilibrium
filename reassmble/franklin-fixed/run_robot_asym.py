import numpy as np
import copy
from robot_model_asym import Model
    ...
    "a1":
    {
        ...
        {  
            ...
            "model_config": 
            {
                ...
                "N": 5,
                "memory" : {"lambda": np.array([1, 1, 1, 1]), "theta":np.ones((5)), "x": np.zeros((2)), "dot_x": np.zeros((2)), "y": np.full((2), 0), "z": np.zeros((5, 2)), "v": np.zeros((5, 2)), "gama": np.zeros((1))},
                ...
                'private': {
                '0': { 'alpha': [100, 125, 110], 'beta':[125, 105, 100], 'eta': [2, 1.9, 1.9], 'h1': 2.0, 'h2': 2.0},
                '1': {'alpha': [110, 120, 125], 'beta':[115, 100, 110], 'eta': [1.95, 1.8, 2.0], 'h1': 2.0, 'h2': 2.0},
                '2': {'alpha': [115, 115, 105], 'beta':[110, 110, 125], 'eta': [1.9, 2, 1.95], 'h1': 2.0, 'h2': 2.0},
                '3': {'alpha': [120, 110, 100], 'beta':[100, 120, 120], 'eta': [1.85, 1.95, 2.0], 'h1': 2.0, 'h2': 2.0},
                '4': {'alpha': [125, 100, 115], 'beta':[105, 115, 105], 'eta': [1.8, 1.85, 1.85], 'h1': 2.0, 'h2': 2.0},
                },
            }
        }
    },
