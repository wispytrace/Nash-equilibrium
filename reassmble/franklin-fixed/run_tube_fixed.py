    ...
    "a_2":
    {
        ...
        {  
            ...
            "model_config": 
            {
                ...
                "N": 5,
                "memory" : {"x": np.zeros((1)), "dot_x": np.zeros((1)), "y": np.full((1), 0), "z": np.zeros((5, 1)), "v": np.zeros((5, 1)), "gama": np.zeros((1))},
                'T_m': [1.1, 1.2, 1.0, 1.1, 1.0, 1.2],
                'T_e': [0.8, 0.9, 0.8, 0.9, 0.8, 0.9],
                'K_m': [1.2, 1.3, 1.2, 1.3, 1.2, 1.3],
                'share': {
                ...
                'private': {
                '0': { 'alpha': [0, 10, 10], 'beta':[0, 10, 10], 'eta': [0, 0, 1], 'h1': 2, 'h2': 2, 'xi':6},
                '1': { 'alpha': [0, 10, 10], 'beta':[0, 10, 10], 'eta': [0, 0, 1], 'h1': 2, 'h2': 2, 'xi':7},
                '2': { 'alpha': [0, 10, 10], 'beta':[0, 10, 10], 'eta': [0, 0, 1], 'h1': 2, 'h2': 2, 'xi':8},
                '3': { 'alpha': [0, 10, 10], 'beta':[0, 10, 10], 'eta': [0, 0, 1], 'h1': 2, 'h2': 2, 'xi':9},
                '4': { 'alpha': [0, 10, 10], 'beta':[0, 10, 10], 'eta': [0, 0, 1], 'h1': 2, 'h2': 2, 'xi':10},
                '5': { 'alpha': [0, 10, 10], 'beta':[0, 10, 10], 'eta': [0, 0, 1], 'h1': 2, 'h2': 2, 'xi':11}
                },
            }
        }
    },
