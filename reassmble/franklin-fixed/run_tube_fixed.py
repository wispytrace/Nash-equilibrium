    ...
    "r_0":
    {
        ...
        {  
            ...
            "model_config": 
            {
                ...
                "N": 6,
                "memory" : {"x": np.zeros((1)), "dot_x": np.zeros((1)), "y": np.full((1), 0), "z": np.zeros((5, 1)), "v": np.zeros((6, 1)), "gama": np.zeros((1))},
                'T_m': [1.1, 1.2, 1.0, 1.1, 1.0, 1.2],
                'T_e': [0.8, 0.9, 0.8, 0.9, 0.8, 0.9],
                'K_m': [1.2, 1.3, 1.2, 1.3, 1.2, 1.3],
                'share': {
                    "init_value_x": np.array([0, 0.5, 1, 1.5, 2]),
                    "init_value_dotx": np.array([-2, -1, -2, 1, 2]),
                ...
                'private': {
                '0': { 'alpha': [10, 10, 10], 'beta':[10, 10, 10], 'eta': [1, 1, 1], 'h1': 2, 'h2': 2, 'xi':5},
                '1': { 'alpha': [10, 10, 10], 'beta':[10, 10, 10], 'eta': [1, 1, 1], 'h1': 2, 'h2': 2, 'xi':6},
                '2': { 'alpha': [10, 10, 10], 'beta':[10, 10, 10], 'eta': [1, 1, 1], 'h1': 2, 'h2': 2, 'xi':7},
                '3': { 'alpha': [10, 10, 10], 'beta':[10, 10, 10], 'eta': [1, 1, 1], 'h1': 2, 'h2': 2, 'xi':8},
                '4': { 'alpha': [10, 10, 10], 'beta':[10, 10, 10], 'eta': [1, 1, 1], 'h1': 2, 'h2': 2, 'xi':9},
                },
            }
        }
    },
