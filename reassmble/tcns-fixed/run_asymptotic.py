    ...
    "r_a":
    {
        ...
        {  
            ...
            "model_config": 
            {
                ...
                'private': 
                {
                    '0': { 'c1': 50, 'c2':50, 'delta': 5, 'eta': 5, 'epsilon': 0, 'r':5.0},
                    '1': {'c1': 50, 'c2':50,'delta': 5, 'eta': 5, 'epsilon': 0, 'r': 5.5},
                    '2': {'c1': 50, 'c2':50,'delta': 5, 'eta': 5, 'epsilon': 0, 'r': 6.0},
                    '3': {'c1': 50, 'c2':50,'delta': 5, 'eta': 5, 'epsilon': 0, 'r': 6.5},
