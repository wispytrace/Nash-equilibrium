...
class Model:
    ...
    def receieve_msg(self, adj_agent_id, memory):
        ...
        self.memory_updation['gama'] += np.fabs(memory['gama'])
    ...
    def estimation_update_function(self):
        ...
        gama = self.memory_updation['gama'] * self.model_config['gama']
    ...
    def status_update_function(self):
        ...
        update_value_fabs = np.fabs(update_value)

        update_value = (sign*delta*np.power(update_value_fabs, p) + sign *
                         eta*np.power(update_value_fabs, q) + sign*epsilon*update_value_fabs)
    ...
    def update(self):
        ...
        self.memory['gama'] = self.memory_updation['x']
        self.reset_memroy_updation()
